    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifiants', models.CharField(blank=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('project', models.ManyToManyField(related_name='contributors', to='sd_support.project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sd_support.issue')),
            ],
        ),
    ]
